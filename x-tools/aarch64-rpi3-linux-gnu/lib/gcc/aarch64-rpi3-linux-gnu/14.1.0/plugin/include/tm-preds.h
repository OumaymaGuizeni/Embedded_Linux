/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/yasser_jemli/embedded_operating_system/task_2/crosstool-ng/.build/aarch64-rpi3-linux-gnu/src/gcc/gcc/config/aarch64/aarch64.md'.  */
